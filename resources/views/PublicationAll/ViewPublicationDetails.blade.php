    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                ...
                <td style="padding: 8px;"><a href="{{ $publication->Publication_File }}">Click Here</a></td>
            </tr>
            <tr>
        ...
        <div style="text-align:center; margin-top:20px;">
            <a href="{{ route('PublicationAll.ViewPublicationList') }}" class="btns">Back to Publications</a>
        </div>
    </div>
</div>
@endsection
